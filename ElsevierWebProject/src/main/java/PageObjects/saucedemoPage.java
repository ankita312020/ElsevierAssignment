...
public class saucedemoPage extends BaseClass{
	...
	public void getUserName() {
		utils.sendKeys(driver, userName, "standard_user", 10);
	}
	public void getPassword() {
		utils.sendKeys(driver, password, "secret_sauce", 10);
	}
	...
	public void getfName() {
		utils.sendKeys(driver, fName, "ankita", 10);
	}
	public void getlName() {
		utils.sendKeys(driver, lName, "govind", 10);
	}
	public void getpCode() {
		utils.sendKeys(driver, pCode, "1234", 10);
	}
